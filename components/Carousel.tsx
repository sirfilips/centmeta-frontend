...
const Carousel = ({ title, items, onItemClick, onViewAll, viewAllHref, isHot = false, isCard = false }: any) => {
  ...
  return (
    <div className="mb-8 md:mb-10">
      ...
      {/* Margine sotto il titolo ridotto da mb-6 a mb-2 md:mb-3 */}
      ...
      {/* Contenitore relativo isolato per calcolare la posizione esatta delle frecce */}
      <div className="relative group/carousel">
        
        {/* Frecce centrate perfettamente: 20px (pt-5) + 128px (metà altezza carta) = 148px */}
        ...
        {/* pt-5 crea lo spazio interno esatto per non far tagliare la carta quando si solleva */}
                ...
                <div className="relative w-full h-64 flex justify-center items-center mb-3">
                  {isPartner && item.images.length > 1 ? (
                    <div className="relative w-full h-full flex justify-center items-center">
                      {/* Animazione esclusiva sull'immagine per farla salire in primo piano (z-40) */}
