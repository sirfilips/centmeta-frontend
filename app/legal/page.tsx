      ...
      <div className="flex-grow pb-24 max-w-[1000px] w-full mx-auto px-4 md:px-8 mt-12">
        ...
        <div className="bg-slate-900/40 border border-slate-800 rounded-3xl p-6 sm:p-10 lg:p-14 shadow-2xl relative isolate overflow-hidden space-y-12 lg:space-y-16">
          ...
          <section>
            ...
            <div className="space-y-4 text-sm md:text-base lg:text-lg text-slate-300 leading-relaxed">
              <p>
                Le liste dei mazzi analizzate derivano da liste rese pubbliche dai rispettivi autori su Moxfield, servizio con cui CentMeta non ha alcuna affiliazione ufficiale. Di ciascun mazzo vengono conservati solo l&apos;identificativo pubblico, il comandante, la data di aggiornamento e l&apos;elenco delle carte. La raccolta dei dati avviene tramite un accesso concordato con Moxfield, nel rispetto del limite di frequenza da loro indicato. CentMeta è e resterà gratuito per tutti gli utenti. Chi non desidera che un proprio mazzo sia incluso nelle statistiche può scrivere a privacy@centmeta.it per chiederne la rimozione (artt. 17 e 21 GDPR).
              </p>
              <p>
